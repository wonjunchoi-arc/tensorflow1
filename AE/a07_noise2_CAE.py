...
def autoencoder2(hidden_layer_size): 
    ...
    x=Conv2D(10,(2,2) #dense의 아웃풋은 unit이다.
    ,input_shape=(28,28,1), activation='relu',padding='same')(input)
    print(x)
    x=MaxPool2D((2,2))(x)
    x = Conv2D(10,(2,2), activation='relu',padding='same')(x)
    x= MaxPool2D((2,2))(x)
    x = Conv2D(10,(2,2), activation='relu',padding='same')(x)
...
model = autoencoder2(hidden_layer_size=30) # pca 95%
