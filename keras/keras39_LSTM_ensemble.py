...
dense2 = Dense(10, activation='relu', name='dense1')(dense1)
dense3 = Dense(10, activation='relu',name='dense2')(dense2)
dense4 = Dense(10, activation='relu',name='dense3')(dense3)
dense5 = Dense(10, activation='relu',name='dense4')(dense4)
output1 = Dense(1,name='output1')(dense4)

#2-2. 모델 2

input2 = Input(shape=(3,1))
dense10 = LSTM(units=64, activation='relu')(input2)
dense11 = Dense(10, activation='relu',name='dense11')(dense10)
...
hist = model.fit([x1,x2],y, epochs=1, batch_size=1,callbacks=[es])
