...
np.save('./_save/_npy/image/k59_3_train_x.npy', arr=xy_train[0][0])
np.save('./_save/_npy/image/k59_3_train_y.npy', arr=xy_train[0][1])
np.save('./_save/_npy/image/k59_3_test_x.npy', arr=xy_test[0][0])
np.save('./_save/_npy/image/k59_3_test_y.npy', arr=xy_test[0][1])
