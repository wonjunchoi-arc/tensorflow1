...
x_train = np.load('./_save/_npy/x_train_mnist.npy')
y_train = np.load('_save/_npy/y_train_mnist.npy')
x_test = np.load('./_save/_npy/x_test_mnist.npy')
y_test = np.load('./_save/_npy/y_test_mnist.npy')
