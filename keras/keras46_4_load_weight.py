...
# model.load_weights('./_save/keras46_3_save_weight_1.h5')
#여기서는 순수한 weight만 저장 했기에 모델이 없고 compile도 필요하다. 
#save weight에는 model이 저장되지 않는다. 
#load model이 아닌 load weight 가 따로 존재한다. 
