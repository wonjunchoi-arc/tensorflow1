...
model.fit(x1, y, epochs=300, batch_size=3, verbose=3)
end =time.time() - start
print('걸린시간:', end)
...
# verbose
# 0
# 걸린 시간 : 3.1244051456451416
# 1
# 걸린시간: 4.239789009094238
# 2
# 걸린시간: 3.1750354766845703
# 3 
# 걸린시간: 3.1873269081115723
#


# batch size에 다른 시간의 차이도 적어두기
