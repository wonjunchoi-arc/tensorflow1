...
print(x1.shape, x2.shape, y1.shape) #(100, 3) (100, 3) (100,) (100,)

x3_train, x3_test,x4_train, x4_test, y1_train, y1_test, y2_train, y2_test = train_test_split(
    x3,x4, y1,y2, train_size=0.90,
)


print(x3_train.shape,x4_train.shape,
...
model.fit([x3, x4],[y1, y2], epochs=100, batch_size=8, verbose=1  )#x가 두개면 그냥 리스트로 주면 되는 구나!!

#4. 평가 예측
loss = model.evaluate([x3_test,x4_test], [y1_test, y2_test])
# print('loss' ,loss[0])
print('loss' ,loss[0])
