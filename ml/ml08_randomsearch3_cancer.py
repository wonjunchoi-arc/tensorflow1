...
걸린시간 6.339998483657837
최적의 매개변수: RandomForestClassifier(max_depth=8, min_samples_leaf=5, min_samples_split=10,
                       n_jobs=-1)
best_param: {'n_jobs': -1, 'n_estimators': 100, 'min_samples_split': 10, 'min_samples_leaf': 5, 'max_depth': 8}
best_score : 0.95960254618848
model.score : 0.9799498746867168
정답률 : 0.9799498746867168
